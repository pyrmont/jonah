...
class EditController < ApplicationController
  ...
  #
  # PARAMETERS
  # :path   (String) A path somewhere in the content directory. This variable
  #                  is expected to be Base64-encoded.
  #
  # EXPLANATION
  # First, set the path variable. Then check if the path is valid and halt
  # processing if not (rendering an error template). If the path is valid,
  ...
  #
  # PARAMETERS
  # :path   (String) A file somewhere in the content directory. This variable
  #                  is expected to be Base64-encoded.
  #
  # EXPLANATION
  # First, set the path variable. Then check if the path is valid and halt
  # processing if not (rendering an error template). If the path is valid,
  # decode the path and then create a content variable. Then render the edit
  # template.
  get '/:path' do
    path = params[:path]
  ...
  #
  # EXPLANATION
  # First, set the path variable based on the submitted path parameter. Then
  # check if the path is valid (a path must be provided otherwise the code will
  # be halted). If the path is valid, decode the path and then extract the
  # contents from the parameters hash. Then write the contents to the file.
  # Last redirect to the route for that path.
  #
  # TODO
